...
populate_jar_config_file_paths() {
  ...
  if [ $github_actions_path ]; then
    jar_file_path="$github_actions_path/festify-android-tools/$buf_file_name"
    config_file_path="/home/runner/work/festify-android/festify-android/buf.yaml"
  else
    jar_file_path="../festify-android-tools/$buf_file_name"
